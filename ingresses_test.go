...
func TestClient_ListIngresses(t *testing.T) {
	...
	clientset, clientsetError := NewClientFromKubeFile("https://feidsupplyaks001-2bd25411.hcp.eastus2.azmk8s.io:443", "/Users/d.gallmeier/.kube/config.yml")
...
func TestClient_ListIngressesSandbox(t *testing.T) {
	namespace := "supply-ferguson-poc"
	clientset, clientsetError := NewClientFromKubeFile("https://feiseu2supplyaks001-92ae9238.hcp.eastus2.azmk8s.io:443", "~/go/src/k8s_client_go")
	ingresses, ingressesError := clientset.ListIngresses(namespace)
